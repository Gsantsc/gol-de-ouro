  ...
  return (
    <View style={styles.breakdownRow}>
      ...
      <View style={styles.breakdownTextBox}>
        ...
        <Text numberOfLines={2} style={styles.breakdownValue}>
          {value}
        </Text>
      </View>
      <Text style={[
        styles.breakdownPoints,
        tone === "hit" ? styles.breakdownPointsHit : styles.breakdownPointsMuted
      ]}>
        {pointsLabel}
      </Text>
    </View>
    ...
    <View style={styles.predictionCard}>
      ...
      <View style={styles.breakdownBox}>
        ...
        <BreakdownRow
          ...
          status={breakdown?.main.status ?? "pending"}
        ...
        <BreakdownRow
          ...
          status={breakdown?.extras.firstScorer.status ?? "pending"}
