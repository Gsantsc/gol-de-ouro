...
export type Match = {
  ...
  home_source_result?: "winner" | "loser" | "fixed_team" | string | null;
  away_source_result?: "winner" | "loser" | "fixed_team" | string | null;
  home_original_placeholder?: string | null;
  away_original_placeholder?: string | null;
  is_bracket_validated?: boolean;
  bracket_validation_error?: string | null;
